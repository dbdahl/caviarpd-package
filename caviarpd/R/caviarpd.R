...
#' \code{nClusters} argument. #'  If \code{nClusters} is a single integer, then
#' a clustering estimate with \code{nClusters} clusters will be returned.
#'
...
#' @export
#'
caviarpd <- function(distance, nClusters, mass=NULL, nSamples=500, gridLength=10,
...
# #'
# caviarpd_original <- function(distance, nClusters, mass, nSamples=1000, gridLength=10, samplesOnly=FALSE,
